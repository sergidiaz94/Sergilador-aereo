...
export const env = {
  ...
  flightsSky: {
    // Clau de RapidAPI per a "Flights Scraper Sky" (Skyscanner no oficial).
    // Font addicional a Travelpayouts; si falla, simplement no aporta
  ...
  footballData: {
    ...
    // ID de l'equip a football-data.org (RCD Espanyol de Barcelona = 80).
    teamId: process.env.FOOTBALL_DATA_TEAM_ID || '80',
  },
  openWeather: {
